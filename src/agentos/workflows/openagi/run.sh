...
echo "  python src/agentos/resource/api_server.py --redis_ip 127.0.0.1 --redis_port 6380 --flask_port 5000"
echo "  python src/agentos/scheduler/scheduler.py --master_addr 127.0.0.1:5000 --redis_ip 127.0.0.1 --redis_port 6380 --strategy hacs --flask_port 5001"
echo "  python src/agentos/agent/dispatch_task.py --master_addr 127.0.0.1:5001"
