...
from core.scheduler.fcfs import dag_manager_fcfs
from core.scheduler.hacs import dag_manager_hacs
from core.scheduler.atlas import dag_manager_atlas
from core.scheduler.peft import dag_manager_peft
...
def parse_args():
    ...
    parser.add_argument("--dag_path", default= "src/core/workflows",
    ...
    parser.add_argument("--time_pred_model_path",  default="src/core/utils/timepred/model", 
    ...
    args.task_exec_time_csv= os.path.join(args.proj_path, "src/core/results", args.task_exec_time_csv)
    args.task_exec_result_jsonl= os.path.join(args.proj_path, "src/core/results", args.task_exec_result_jsonl)    
    return args
